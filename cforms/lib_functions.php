...
function cforms_scripts() {
	...
	if ( strpos($request_uri,'cforms-options')!==false ){
	    ...
	    wp_register_script('cforms_admin_cal',$r.'/js/cformsadmincal.js',false, cforms::VERSION );
	    wp_enqueue_script('cforms_admin_cal');
	}

    wp_deregister_script('prototype');

    wp_register_script( 'cforms_interface',$r.'/js/interface.js', false, cforms::VERSION );
    wp_register_script( 'cforms_admin',$r.'/js/cformsadmin.js', false, cforms::VERSION );
...
function cforms_options_page_style() {
	...
	echo "\n<!-- Start Of Script Generated By cformsII v" . cforms::VERSION . " [Oliver Seidel | www.deliciousdays.com] -->\n";
...
?>	<p style="padding-top:50px; font-size:11px; text-align:center;">
	...
	<p align="center">Version v<?php echo cforms::VERSION; ?></p>
<?php
}
