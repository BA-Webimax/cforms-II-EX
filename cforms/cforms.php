...
Version: 14.6.2
Author: Matthew Sigley, Oliver Seidel, Brian Ashe
Author URI: https://github.com/msigley/
License: Copyright 2006-2012 Oliver Seidel (email : oliver.seidel @ deliciousdays.com)
...
function cforms_script() {
	global $wp_query, $cforms_root, $cformsSettings;
	...
	if( $onPages=='' || (in_array($page_obj->ID,$onPagesA) && !$exclude) || (!in_array($page_obj->ID,$onPagesA) && $exclude)){
		...
		echo "\n<!-- Start Of Script Generated By cforms v" . cforms::VERSION . " [Oliver Seidel | www.deliciousdays.com] -->\n";
